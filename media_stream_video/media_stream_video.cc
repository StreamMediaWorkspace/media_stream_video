...
#ifdef _DEBUG_
#pragma comment(lib, "./lib/win32/Debug/ppapi.lib")
#pragma comment(lib, "./lib/win32/Debug/ppapi_cpp.lib")
#pragma comment(lib, "./lib/win32/Debug/ppapi_gles2.lib")
#else
#pragma comment(lib, "./lib/win32/Release/ppapi.lib")
#pragma comment(lib, "./lib/win32/Release/ppapi_cpp.lib")
#pragma comment(lib, "./lib/win32/Release/ppapi_gles2.lib")
#endif
