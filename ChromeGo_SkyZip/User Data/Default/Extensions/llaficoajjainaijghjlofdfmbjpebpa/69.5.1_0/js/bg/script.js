(function() {
  ...
  window.addEventListener("load", function() {
    ...
    function openSpeedDialSingle(tabPosition) {
      var foundTabId = null;
      var foundTabIndex;
      fvdSpeedDial.Utils.Async.chain([
        function(chainCallback) {
    ...
    chrome.browserAction.onClicked.addListener(function(tab) {
      ...
      if(action === "sd_in_new_tab") {
        openSpeedDialSingle("newtab");
      }
      else if(action === "sd_in_active_tab") {
        openSpeedDialSingle("active");
      }
    ...
    if(chrome.runtime.setUninstallURL) {
      chrome.runtime.setUninstallURL(fvdSpeedDial.Config.UNINSTALL_URL);
    }
    else {
