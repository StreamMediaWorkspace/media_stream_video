(function(){
  ...
  //            img.setAttribute("src", preview.url);
    ...
    AddDial:{
      ...
      getTitle: function( callback ){// Task #1415
        ...
        if( !parsed || !parsed.host || String(parsed.host).split('.').pop().length < 2) return;
          ...
          var currentTitle = String(document.getElementById( "addDialog_title" ).value); // Task #1585          
          if(!currentTitle || currentTitle == _("dialog_add_dial_dynamic_title")){// Task #1585
