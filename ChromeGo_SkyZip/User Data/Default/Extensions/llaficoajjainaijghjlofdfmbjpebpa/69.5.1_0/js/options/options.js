(function(){
  ...
  const DONATE_FRAME_URL = "https://everhelper.me/paypal-donate/donate.php";
  ...
  Options.prototype = {
    ...
    window.addEventListener('resize', function() {
      ...
      if(fvdSpeedDial.Donate.canShow()) {
        var startDonateButton = document.querySelector("#startDonateButton");
        var donateContainer = document.querySelector("#donate-container");
        startDonateButton.setAttribute("show", 1);
        document.querySelector("#donate-container .close-donate").addEventListener("click", function() {
          donateContainer.removeAttribute("show");
          setTimeout(function() {
            donateContainer.setAttribute("hidden", true);
          }, 200);
        }, false);
        startDonateButton.addEventListener("click", function() {
          window.open("https://paypal.me/NimbusWeb");
        }, false);
      }
    },
