(function() {
  ...
  function AmazonInfoPopup() {
    ...
    this.elem = null;
    this.frame = null;
    //this.urlTemplate = "http://localhost/fvdsd-tools/amazon-product.php?asin=%asin%&url=%url%";
    this.urlTemplate = "http://fvdspeeddial.com/fst/amazon-product.php?asin=%asin%&url=%url%";
