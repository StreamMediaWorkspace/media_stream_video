(function(){
  ...
  SpeedDial.prototype = {
    ...
    init: function() {
      ...
      window.addEventListener("keydown", function( event ){ // Task #1247
          if(event.ctrlKey){
    ...
    openDialByNum: function( num, event ){//Task #1247
        ...
        fvdSpeedDial.Utils.Opener.asClicked( url, fvdSpeedDial.Prefs.get( "sd.default_open_in" ), event );
    },
