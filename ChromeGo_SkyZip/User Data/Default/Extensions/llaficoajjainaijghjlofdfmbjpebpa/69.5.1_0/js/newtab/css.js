    ...
    refresh: function(){
      ...
      if( !_b( fvdSpeedDial.Prefs.get("sd.display_quick_menu_and_clicks" ) ) ){
        ...
        try{// #Task 1099
            ...
            if(group_active_bg != "75AD66"){ // Task #1288
        ...
        if(!_b(fvdSpeedDial.Prefs.get("sd.display_clicks"))){
            classesColors[".newtabCell .text"] = {
                "display": "none"
            };             
            classesColors[".newtabCell .mostVisitedMenu"] = {// Task #1676
              "display": "none"
            };
            classesColors[".newtabCell[type='mostvisited'] .menuOverlay"] = {// Task #1676
                "padding-bottom": "0!important"
            };
        }
