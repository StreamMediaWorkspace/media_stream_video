...
(function(){
  ...
  Utils.prototype = {
    ...
    getUserClientDetails: function(cb) {
      var xhr = new XMLHttpRequest();
      xhr.open("GET", "http://everhelper.me/spec/country.php?detailed=1");
      xhr.onload = function() {
    ...
    cacheTitle: {},// Task #1415
    getTitleReq: false,// Task #1415
    getTitleForUrl: function( url, callback, abort ){// Task #1415
        var that = this;
    ...
    reloadAllPages: function(timeout, except){ // Task #2009
        var ts = this;
    ...
    reloadAddonPages: function(callback) { // Task #2009
        var tabs = [];
    ...
    getInstallVersion: function(){ // #2098
